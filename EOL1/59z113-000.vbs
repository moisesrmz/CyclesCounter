...
If contents >= 100000 Then
	...
	x=msgbox("Se han rebasado las 50,000 activaciones de la contraparte '59Z113-000', favor de contactar a Ingenieria de Pruebas.",16,"Limite Rebasado")
	Set WshShell = CreateObject("WScript.Shell")
	Set WshShellExec = WshShell.Exec(strCommand)	
End If
'kill proces end

Set objReadFile = objFSO.OpenTextFile("\\mlxgumvwfile01\Departamentos\Fakra\Pruebas\CyclesCounter\EOL1\59z113-000.txt", 2, False)
