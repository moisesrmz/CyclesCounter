...
If contents >= 30000 Then
	...
	x=msgbox("Se han rebasado las 30,000 activaciones de la contraparte '59Z118-C00', favor de contactar a Ingenieria de Pruebas.",16,"Limite Rebasado")
	Set WshShell = CreateObject("WScript.Shell")
	Set WshShellExec = WshShell.Exec(strCommand)	
End If
'kill proces end

Set objReadFile = objFSO.OpenTextFile("\\mlxgumvwfile01\Departamentos\Fakra\Pruebas\CyclesCounter\EOL1\59z118-c00.txt", 2, False)
