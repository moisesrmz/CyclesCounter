...
class FullscreenOverlay:
    ...
    def show(self):
        ...
        self.top.attributes("-alpha", 0.3)      # <- como pediste
        self.top.configure(bg="#000000")        # negro con alpha 0.3 (velo)
...
class UiMonitorThread(threading.Thread):
    """
    Hilo daemon: detecta estado (Good/Bad/Testing) y lo manda a cola.
    """
        ...
        try:
            ...
            while self._running.is_set():
                try:
                    ...
                    with open("monitor_crash_log.txt", "a", encoding="utf-8") as f:
                        f.write("\n\n=== MONITOR EXCEPTION ===\n")
                        f.write(msg)
                    print("[Monitor] excepción (ver monitor_crash_log.txt):", e)
...
# =======================
#  Opcional: VBS toggle (igual que tu versión)
# =======================
...
# =======================
#  Drag de ventana (igual que tu versión)
# =======================
